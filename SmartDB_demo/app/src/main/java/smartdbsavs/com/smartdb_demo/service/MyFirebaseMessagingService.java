...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    //    public static MessageShow messageShow = new MessageShow("");
    @Override
...
//        messageShow.setMsg(remoteMessage.getNotification().getBody());
